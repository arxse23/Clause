...
def rewrite_question(question, previous_questions):
    ...
    prompt = f"""You are a query writing component for a document retrieval system. Rewrite the users question into a standalone search query. Rules: No commentary, output ONLY rewritten query.\n\nPrevious:\n{history_block}\n\nCurrent: {question}"""
